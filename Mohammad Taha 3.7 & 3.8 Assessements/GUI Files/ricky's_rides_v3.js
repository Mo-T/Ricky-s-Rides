...
function checkDetailInputs() {
	alert("In the checkDetailInputs function"); //Test alert
	var firstName = document.getElementById("firstNameInput").value;
	alert("First Name: " + firstName);//Test alert
	var lastName = document.getElementById("lastNameInput").value;
	alert("Last Name: " + lastName);//Test alert
	var emailAddress = document.getElementById("emailInput").value;
	alert("Email Address: " + emailAddress);//Test alert
	var cellphoneNumber = document.getElementById("cellphoneInput").value;
	alert("Cellphone Number: " + cellphoneNumber);//Test alert
	var userAge = document.getElementById("ageInput").value;
	alert("Age: " + userAge);//Test alert
	var licenseNumber = document.getElementById("driversLicenseInput").value;
	alert("NZ Drivers License Number: " + licenseNumber);//Test alert
