...
function checkDetailInputs() {
	...
	if (document.getElementById("checkInDate").validity.valueMissing || document.getElementById("checkInDate").validity.rangeUnderFlow || document.getElementById("checkInDate").validity.rangeOverFlow) {
		...
		document.getElementById("errorMessageAccordions").innerHTML = "Please fill in the fields with valid information and follow the requested format";
	...
	if (document.getElementById("numberDays").validity.valueMissing || document.getElementById("numberDays") == null || document.getElementById("numberDays").validity.rangeOverflow || document.getElementById("numberDays").validity.rangeUndeflow) {
		...
		document.getElementById("errorMessageAccordions").innerHTML = "Please fill in the following fields with valid information";
		window.scrollTo(0, document.getElementById("accordionWindowScroll").offsetTop - 39);
		document.getElementById("disableBookingDetails").style.border = "5px solid red";
		return;
	} else {
	...
	if (document.getElementById("ageInput").validity.rangeOverflow || document.getElementById("ageInput").validity.rangeUnderflow || document.getElementById("ageInput").validity.valueMissing) {
...
//	if (carSelected == true && checkInDate == true && numberDays == true && firstName == true && lastName == true && cellphoneNumber == true && userAge == true && licenseNumber == true && emailAddress == true) {
//		window.scrollTo(0, document.getElementById("bookingInformation").offsetTop - 39);
//	}
